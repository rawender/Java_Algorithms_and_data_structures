...
public class Tests {
    ...
    @Test
    void sortTests(){
        File in = new File("E:\\Study\\Algorithms_and_data_structures_in_Java\\AS_geek_brains1\\lesson2\\src\\main\\resources\\sort.txt"), //Поменять адрес на актуальный!
                out = new File("E:\\Study\\Algorithms_and_data_structures_in_Java\\AS_geek_brains1\\lesson2\\src\\main\\resources\\sort.ans"); //Плменять адрес на актуальный!
